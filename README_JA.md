...
<tr>
<td width="200"><a href="https://flymux.com/register?promo=TINYRDM"><img alt="FlyMux" src="https://github.com/tiny-craft/tiny-rdm/raw/main/docs/images/flymux_logo.png"/></a></td>
<td>FlyMux のご支援に感謝します！FlyMux は Claude Code と Codex 向けに公式で高安定な中継サービスを提供し、開発者にスムーズで効率的な接続体験を届けることに注力しています。<a href="https://flymux.com/register?promo=TINYRDM">このリンク</a>から登録すると、$5 のボーナスクレジットが自動付与されます。</td>
</tr>

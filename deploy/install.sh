...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/DENGXUELIN/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="DENGXUELIN/sub2api"
...
Documentation=https://github.com/DENGXUELIN/sub2api

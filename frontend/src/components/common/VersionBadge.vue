...
const GITHUB_REPO = 'DENGXUELIN/sub2api'
// Custom builds are published to GHCR without a "v" prefix in the image tag.
const DOCKER_IMAGE = 'ghcr.io/dengxuelin/sub2api'

export default {
    accounts: {
      ...
      kiroBatch: {
        menuLabel: '批量导入 Kiro Key',
        title: '批量导入 Kiro API Key',
        keysLabel: 'API Key（每行一个）',
        keysPlaceholder: 'ksk_...\nksk_...\nksk_...',
        keyCount: '{count} 个有效 Key',
        duplicateCount: '已忽略 {count} 个重复项',
        namePrefix: '账号名前缀',
        namePreview: '首个账号：{name}',
        groupsLabel: '目标分组',
        readyCount: '待导入账号',
        selectedGroups: '已选分组',
        resultTitle: '导入结果',
        ...
        importNow: '直接导入',
        importing: '导入中...',
        keysRequired: '请粘贴至少一个 API Key',
        namePrefixRequired: '请输入账号名前缀',
        groupsRequired: '请至少选择一个 Kiro 分组',
        downloaded: '已生成包含 {count} 个账号的 JSON 文件',
        imported: '已成功导入 {count} 个 Kiro 账号',
        completedWithErrors: '批量导入完成：成功 {success}，失败 {failed}',
        importFailed: 'Kiro 批量导入失败'
      },

export default {
    accounts: {
      ...
      kiroBatch: {
        menuLabel: 'Batch Import Kiro Keys',
        title: 'Batch Import Kiro API Keys',
        keysLabel: 'API keys (one per line)',
        keysPlaceholder: 'ksk_...\nksk_...\nksk_...',
        keyCount: '{count} valid keys',
        duplicateCount: '{count} duplicate(s) ignored',
        namePrefix: 'Account name prefix',
        namePreview: 'First account: {name}',
        groupsLabel: 'Target groups',
        readyCount: 'Accounts ready',
        ...
        importing: 'Importing...',
        keysRequired: 'Paste at least one API key',
        namePrefixRequired: 'Enter an account name prefix',
        groupsRequired: 'Select at least one Kiro group',
        downloaded: 'Generated a JSON file with {count} accounts',
        imported: 'Imported {count} Kiro accounts',
        completedWithErrors: 'Batch import finished: {success} succeeded, {failed} failed',
        importFailed: 'Kiro batch import failed'
      },
